  ...
  <div className="App">
    ...
    {results && results.status==='200' && (
      <div className='results'>
        ...
        <p>ID: {results.id}</p>
        {results.id ? <img className="pokemon-sprite" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${results.id}.png`} alt="Pokemon sprite" /> : null}      </div>            
    )}
    {results && results.status!=='200' && (
      <div className='results'>
